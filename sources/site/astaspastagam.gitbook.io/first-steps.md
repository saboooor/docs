# Source: https://astaspastagam.gitbook.io/first-steps

For the complete documentation index, see [llms.txt](https://astaspastagam.gitbook.io/first-steps/llms.txt). This page is also available as [Markdown](https://astaspastagam.gitbook.io/first-steps/get-started.md).
...
To create a portal, you need to go to [https://astaspasta.alwaysdata.net/](https://astaspasta.alwaysdata.net/) and click on the Portal creator. From there, you can fully customize your portal.
...
[NextCommands](https://astaspastagam.gitbook.io/first-steps/commands)
