...
\`\`\`
GET https://astaspastagam.gitbook.io/first-steps/configuring-dimensions/addons/premium-addons/random-location-addon.md?ask=<question>&goal=<endgoal>
\`\`\`
