...
\`\`\`
GET https://astaspastagam.gitbook.io/first-steps/configuring-dimensions/addons/premium-addons/better-portals-addon.md?ask=<question>&goal=<endgoal>
\`\`\`
