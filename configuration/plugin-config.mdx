...
<ParamField path="checkForUpdatesOnStartup" type="boolean" default="false">
  When set to `true`, Dimensions checks for available addon updates every time the server starts and installs any new versions it finds automatically.
</ParamField>
